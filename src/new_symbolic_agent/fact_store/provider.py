...
from new_symbolic_agent.errors import ProviderError
from new_symbolic_agent.ir.fact_schema import FactSchema, FactView, PredicateSchema
from new_symbolic_agent.ir.filters import FilterAST, apply_filter
    ...
    def __init__(
        ...
        if not isinstance(schema, FactSchema):
            raise ProviderError(
                ...
                "not the CSV mapping schema. Use new_symbolic_agent.ir.fact_schema.FactSchema."
            )
